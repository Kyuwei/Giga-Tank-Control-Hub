...
lv_color_t COL_DARK;
lv_color_t COL_BAR;
lv_color_t COL_NEON;      // vert neon #39FF14
...
static void cb_thermal(lv_event_t * e)     { Keyboard.printf("n"); }
static void cb_rangefinder(lv_event_t * e) { Keyboard.printf("r"); }
static void cb_track(lv_event_t * e)       { Keyboard.printf("x"); }
static void cb_towcable(lv_event_t * e)    { Keyboard.printf("0"); }
static void cb_arty_coord(lv_event_t * e)  { Keyboard.printf("m"); }
